...
if ( ! function_exists( 'opus_primus_enqueue_scripts' ) ) {
    ...
    function opus_primus_enqueue_scripts() {
        ...
        /** Enqueue Opus Primus Content Widths which will enqueue jQuery as a dependency */
        wp_enqueue_script( 'opus-primus-content-widths', OPUS_JS . 'opus-primus-content-widths.js', array( 'jquery' ), wp_get_theme()->get( 'Version' ), 'true' );
